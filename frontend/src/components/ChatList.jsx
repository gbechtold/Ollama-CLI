    ...
    <div className="mt-4 space-y-3">
      ...
      {history.length > 0 && (
        <button
          ...
          className="mt-6 w-full p-3 text-red-500 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg flex items-center justify-center gap-2 transition-colors duration-200"
        >
